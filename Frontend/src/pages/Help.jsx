  ...
  return (
    <div className="card overflow-hidden">
      ...
      >
        ...
        <svg aria-hidden="true" className={'shrink-0 text-brand-600 dark:text-brand-400 transition-transform ' + (open ? 'rotate-180' : '')} width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round"><path d="M6 9l6 6 6-6"/></svg>
      </button>
